...
| 2026-07-13 | [execution-domain refactor strategy](planning/2026-07-13-execution-domain-refactor-strategy.md) | Design proposal after the first live real run: what the execution domain had to become | Superseded by the cyclic lifecycle — [ADR-003](../decisions/adr-003-cyclic-project-plan-lifecycle.md) |
| 2026-07-14 | [cyclic ProjectPlan implementation record](planning/2026-07-14-cyclic-project-plan-implementation.md) | How un-freeze #4 was actually built | Executed — the current lifecycle |
| 2026-07-15 | [fixing attempts](planning/2026-07-15-fixing-attempts.md) | Walkthrough repairs found by driving the system by hand | Executed |
| 2026-07-28 | [P4.1 — access and setup truth](planning/2026-07-28-phase-4-1-access-and-setup-truth.md) | First-mile truth: readiness, setup, the operator's first hour | Executed (Phase 4.1) |
