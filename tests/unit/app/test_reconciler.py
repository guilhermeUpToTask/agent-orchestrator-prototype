...
from src.core.models import TaskAggregate, TaskStatus, AgentProps, AgentSelector, ExecutionSpec, DomainEvent
...
class TestReconciler:
    ...
    def test_reconcile_dead_agent(self):
        ...
        self.registry.get.return_value = AgentProps(agent_id="a1", name="A1", last_heartbeat=datetime.now(timezone.utc) - timedelta(seconds=300))
