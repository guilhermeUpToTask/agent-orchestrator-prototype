...
2. Run the static boundary check:
   ...
   ```bash
   python plugins/praxis-orchestrator-codex/skills/orchestrator-domain-guard/scripts/check_boundaries.py
   ```
