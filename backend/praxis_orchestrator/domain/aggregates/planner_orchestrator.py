...
from praxis_orchestrator.domain.errors.planning_errors import InvalidEditError, PlanAlreadyTerminalError
...
from praxis_orchestrator.domain.services.navigation import (
    action_for_goal,
    next_action,
    NextAction,
    plan_can_progress,
)
from praxis_orchestrator.domain.value_objects.lifecycle import FailureKind, Status, TERMINAL
