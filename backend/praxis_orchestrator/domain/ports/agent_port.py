...
(praxis_orchestrator/app/ports.py) carrying a `FailureKind` from the shared taxonomy; the
...
from praxis_orchestrator.domain.ports.workplace_port import WorkspaceHandle
