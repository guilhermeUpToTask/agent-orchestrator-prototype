"""
praxis_orchestrator/api/server.py — FastAPI application factory (the thin API).
...
The worker runs as its own process (`praxis worker start`) — the old
...
from praxis_orchestrator.api.dependencies import get_container, set_container
from praxis_orchestrator.api.exceptions import register_exception_handlers
from praxis_orchestrator.api.frontend import bundle_dir, mount_frontend
from praxis_orchestrator.api.logging.config import configure_logging
from praxis_orchestrator.api.middleware.request_logging import RequestLoggingMiddleware
from praxis_orchestrator.api.outbox_relay import run_outbox_relay
from praxis_orchestrator.api.security import require_api_token, require_api_token_or_query
from praxis_orchestrator.api.routers import (
    config,
    evidence,
    review,
    events,
...
from praxis_orchestrator.api.schemas.common import HealthResponse
from praxis_orchestrator.api.sse import get_broker
