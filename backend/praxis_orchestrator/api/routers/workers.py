"""
praxis_orchestrator/api/routers/workers.py — GET /api/workers: is anything going to pick up work?
...
# Three missed beats (see `_HEARTBEAT_SECONDS` in praxis_orchestrator/infra/worker/main.py):
