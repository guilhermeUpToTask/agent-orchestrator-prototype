"""
praxis_orchestrator/api/exceptions.py — the ONE error -> HTTP mapping layer (roadmap 4.1).
...
from praxis_orchestrator.api.middleware.request_logging import get_request_id
from praxis_orchestrator.api.schemas.common import ErrorEnvelope
from praxis_orchestrator.app.forge_port import ForgeError
from praxis_orchestrator.domain.errors.base import DomainError
from praxis_orchestrator.infra.errors import InfrastructureError, UnauthorizedError
