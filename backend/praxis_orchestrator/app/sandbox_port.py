...
(praxis_orchestrator/infra/runtime/cli_runner.py) consumes it, wrapping the exact command it
was already going to run. Adapters live in infra: `NoSandbox`
(praxis_orchestrator/infra/runtime/sandbox.py) is today's behavior and the PERMANENT
