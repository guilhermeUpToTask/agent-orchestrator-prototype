...
from praxis_orchestrator.app.forge_port import ForgeRequestFailedError, PullRequestRef
...
from praxis_orchestrator.app.testing.execution_records import InMemoryExecutionRecordRepository
from praxis_orchestrator.app.testing.acceptance_records import InMemoryAcceptanceRunRepository
from praxis_orchestrator.app.testing.promotion_records import InMemoryGoalPromotionRepository
...
class InMemoryUnitOfWork:
    ...
    def __init__(
        ...
        acceptance_runs: InMemoryAcceptanceRunRepository | None = None,
    ) -> None:
        self.plans = repo
        ...
        self.acceptance_runs = acceptance_runs or InMemoryAcceptanceRunRepository()

    def __enter__(self) -> "InMemoryUnitOfWork":
        self.executions._begin()
        self.promotions._begin()
        self.acceptance_runs._begin()
        return self
