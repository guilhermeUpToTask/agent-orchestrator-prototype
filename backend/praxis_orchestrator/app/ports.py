...
they live in praxis_orchestrator/domain/ports/ and are re-exported here so use cases,
...
(Outbox, UnitOfWork), and Sandbox (praxis_orchestrator/app/sandbox_port.py) — deliberately
...
from praxis_orchestrator.app.execution_records import ExecutionRecordRepository
from praxis_orchestrator.app.acceptance_records import AcceptanceRun, AcceptanceRunRepository
from praxis_orchestrator.app.promotion_records import GoalPromotion, GoalPromotionRepository
from praxis_orchestrator.app.runtime_failures import RuntimeFailure
from praxis_orchestrator.app.sandbox_port import Sandbox, SandboxPolicy, SandboxProbeResult
from praxis_orchestrator.domain.events.base import DomainEvent
from praxis_orchestrator.domain.ports import (
    AgentEventSink,
    AgentRunner,
    Clock,
    Reasoner,
...
from praxis_orchestrator.domain.repositories.goal_lease_repo import GoalLeaseRepository
from praxis_orchestrator.domain.repositories.planner_repo import PlanRepository
...
class PriorAttemptFeedback(Protocol):
    ...
    `praxis_orchestrator/app/agent_feedback.py`): a provider rate limit or a promotion race says
