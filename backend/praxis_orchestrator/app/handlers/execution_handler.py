...
from praxis_orchestrator.domain.events.outbox import (
    CycleVerified,
    GoalCompleted,
    PhaseAdvanced,
    PlanBlocked,
...
from praxis_orchestrator.domain.services.navigation import NOT_READY
...
from praxis_orchestrator.app.ports import PlanningArtifact, PlanningArtifactStore, RepositoryReader
from praxis_orchestrator.app.provider_capacity import (
    CAPACITY_KINDS,
    ProviderCapacityPolicy,
    RoutingPolicy,
)
from praxis_orchestrator.app.runtime_failures import RuntimeFailure, safe_runtime_tail
...
from praxis_orchestrator.app.agent_feedback import split_reasons
from praxis_orchestrator.app.contract_repair import propose_repair
from praxis_orchestrator.domain.services.edit_service import resync_goal_contract
from praxis_orchestrator.app.test_identity import (
    DeclaredChecks,
    criterion_test_map,
    declared_checks,
    existing_checks,
...
from praxis_orchestrator.app.handlers.agent_admission import AgentAdmission, CapacityOutcome
from praxis_orchestrator.app.handlers.goal_promotion import GoalPromoter
from praxis_orchestrator.app.handlers.execution_rules import (
    Unit,
...
from praxis_orchestrator.app.verification import (
    BaselineOutcome,
    baseline_outcome,
    is_check_path,
    sha256_file,
