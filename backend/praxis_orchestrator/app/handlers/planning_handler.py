...
from praxis_orchestrator.domain.aggregates.planner_orchestrator import (
    Plan,
    PlanPhase,
...
from praxis_orchestrator.domain.services.agent_role_resolution import resolve_task_role_agents
from praxis_orchestrator.domain.services.navigation import ready_goal_ids

from praxis_orchestrator.app.provider_capacity import CAPACITY_KINDS, ProviderCapacityPolicy
from praxis_orchestrator.app.handlers.base import Signal
from praxis_orchestrator.app.block_policy import resolutions_for
from praxis_orchestrator.app.execution_records import PlanningOperation, PlanningOperationStatus
import structlog
