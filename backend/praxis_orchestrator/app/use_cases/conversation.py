...
from praxis_orchestrator.domain.events.outbox import IntentProposed, ReviewGateOpened
from praxis_orchestrator.domain.factories.identity import new_id
from praxis_orchestrator.domain.ports.reasoner_port import IntentCandidate, ReasonerReply
...
def _start_operation(
    ...
    with uow:
        ...
        # Domain unfreeze #14: a cyclic plan with an active per-goal block
