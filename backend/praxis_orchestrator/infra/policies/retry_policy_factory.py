"""
praxis_orchestrator/infra/policies/retry_policy_factory.py — build the plan-level RetryPolicy
...
Called fresh at plan-creation time (never cached) so `praxis config set`
...
(praxis_orchestrator/infra/reasoner/factory.py, praxis_orchestrator/infra/runtime/factory.py), but unlike
