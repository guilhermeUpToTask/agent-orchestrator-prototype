"""
praxis_orchestrator/infra/db/reference_repos.py — SQLite reference-data repositories.
...
Integrity rules (see praxis_orchestrator/domain/errors/README.md):
...
from praxis_orchestrator.infra.db.tables import (
