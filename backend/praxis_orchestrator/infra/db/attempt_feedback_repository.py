"""
praxis_orchestrator/infra/db/attempt_feedback_repository.py — the PriorAttemptFeedback port.
...
from praxis_orchestrator.app.ports import PriorAttemptRejection
