"""
praxis_orchestrator/infra/reasoner/stub_reasoner.py — deterministic Reasoner (no LLM).
...
from praxis_orchestrator.infra.runtime.dummy_runner import dry_run_candidate_path
