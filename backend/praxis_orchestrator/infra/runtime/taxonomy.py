"""
praxis_orchestrator/infra/runtime/taxonomy.py — subprocess outcome -> the SHARED FAILURE TAXONOMY.
...
from praxis_orchestrator.app.runtime_failures import LimitScope, RuntimeFailure, safe_runtime_tail
