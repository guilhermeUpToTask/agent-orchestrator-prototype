...
CliAgentRunner (praxis_orchestrator/infra/runtime/cli_runner.py) consumes whichever adapter
it is given identically — it never branches on which one is active.
"""

from __future__ import annotations

from praxis_orchestrator.app.sandbox_port import SandboxPolicy, SandboxProbeResult
