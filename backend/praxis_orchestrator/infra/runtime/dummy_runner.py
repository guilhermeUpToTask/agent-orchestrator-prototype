"""
praxis_orchestrator/infra/runtime/dummy_runner.py — the agent_runner.mode=dry-run runtime.
...
The implementation lives in praxis_orchestrator/app/testing/fakes.py (the application layer may
...
from praxis_orchestrator.app.testing.fakes import DummyAgentRunner, DummyBehavior
from praxis_orchestrator.app.ports import AgentEventSink, WorkspaceHandle
