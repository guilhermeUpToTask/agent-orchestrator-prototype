...
from praxis_orchestrator.app.verification import is_byproduct_path
from praxis_orchestrator.app.ports import Clock, CommandExecution
...
class LocalVerificationExecutor:
    ...
    def _is_byproduct(path: str) -> bool:
        # One definition, shared with the check snapshot in `praxis_orchestrator/app/verification.py`
