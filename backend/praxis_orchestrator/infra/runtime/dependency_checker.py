"""
praxis_orchestrator/infra/runtime/dependency_checker.py — probes the external tools the real
...
from praxis_orchestrator.infra.runtime.registry import RUNTIME_REGISTRY
