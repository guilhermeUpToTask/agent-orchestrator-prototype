"""
praxis_orchestrator/infra/git/workspace.py — Workspace adapters (the async Workspace port).
...
from praxis_orchestrator.app.ports import TaskFailed, WorkspaceHandle
