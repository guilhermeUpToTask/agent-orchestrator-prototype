...
from praxis_orchestrator.infra.git.workspace import GitBranchWorkspace, LocalDirWorkspace
...
def test_concurrent_merge_goal_for_same_cycle_succeeds_for_both_goals(repo, monkeypatch):
    ...
    import praxis_orchestrator.infra.git.workspace as workspace_mod
