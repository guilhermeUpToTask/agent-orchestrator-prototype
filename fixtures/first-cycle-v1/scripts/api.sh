#!/usr/bin/env bash
# Thin curl wrapper for driving the first-cycle fixture over the backend API only.
#
#   ./fixtures/first-cycle-v1/scripts/api.sh GET  /api/plans
#   ./fixtures/first-cycle-v1/scripts/api.sh POST /api/projects '{"name":"first-cycle-v1"}'
